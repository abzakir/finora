...
const sortedTransactions = sortTransactionsByNewest(seedTransactions);
const latestTransaction = getLatestTransaction(seedTransactions);
...
const summaryTiles = [
  {
    ...
    value: String(seedTransactions.length),
    description: 'Seeded records across three months',
    icon: CreditCard,
  },
  {
  ...
  },
  {
    ...
    value: String(seedCategories.length),
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-text-secondary sm:text-base">
              Phase 5A introduces a responsive read-only history view so you can scan transactions on desktop and mobile before adding create, edit, and delete flows.
            </p>
          </div>
      ...
      <Card
        header={
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="text-sm text-text-muted">{sortedTransactions.length} records</p>
          </div>
        }
      >
      ...
      <Card>
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-border/80 bg-surface-alt/70 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-text-muted">Phase 5B will add the transaction form and validation; Phase 5C will handle edit and delete flows.</p>
          </div>
        </div>
      </Card>
    </div>
